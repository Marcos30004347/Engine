...
void VulkanDevice::createLogicalDevice()
{
  ...
  deviceFeatures.fragmentStoresAndAtomics = featureFlags & DeviceFeatures_FragmentStoresAndAtomics ? VK_TRUE : VK_FALSE;
...
GraphicsPipeline VulkanDevice::createGraphicsPipeline(GraphicsPipelineInfo info)
{
  ...
  colorBlendAttachments.reserve(info.fragmentStage.colorAttatchments.size());
