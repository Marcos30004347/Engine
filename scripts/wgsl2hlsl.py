...
def main():
    parser = argparse.ArgumentParser(
        description="Compile WGSL to HLSL using wgslc-naga"
    )
    parser.add_argument("input", help="Input WGSL file")
    parser.add_argument("-o", "--output", required=True, help="Output HLSL file")
    parser.add_argument("--shader-model", default="6_0", 
                        choices=["5_0", "5_1", "6_0", "6_1", "6_2", "6_3", "6_4", "6_5", "6_6", "6_7"],
    ...
    cmd = [
        ...
        "-o", args.output,
        "--hlsl",
        "--hlsl-shader-model", args.shader_model,
    ]
    ...
    try:
        ...
        print("WGSL to HLSL compilation failed", file=sys.stderr)
