...
/// @brief Applies a permutation to the edges array, writing permuted edges into edgesResult.
...
/// @brief Initializes the keys array with each edge's origin vertex and the permutation to the identity.
@compute @workgroup_size(workgroup_size)
...
/// @brief Initializes the keys array with each edge's target vertex and the permutation to the identity.
@compute @workgroup_size(workgroup_size)
